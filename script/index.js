...
for(let i in myArray){
    document.getElementById("products").innerHTML += `<div class="myDivision"><h3>${myArray[i].title}</h3> <br> <img src=' ${myArray[i].image}'/> <br> <h3>${myArray[i].price}</h3> <br> <h3>${myArray[i].description}</h3></div>`
}
/*
